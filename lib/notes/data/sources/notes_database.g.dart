...
class $NotesTable extends Notes with TableInfo<$NotesTable, NoteDto> {
  @override
...
class NoteDto extends DataClass implements Insertable<NoteDto> {
  ...
  NoteDto copyWithCompanion(NotesCompanion data) {
    return NoteDto(
...
class NotesCompanion extends UpdateCompanion<NoteDto> {
...
class $$NotesTableTableManager
    extends
        RootTableManager<
          ...
          (NoteDto, BaseReferences<_$NotesDatabase, $NotesTable, NoteDto>),
          NoteDto,
